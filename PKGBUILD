...
pkgname=cassetteos-local-storage
pkgver=0.4.0
pkgrel=1
pkgdesc="Local Storage service provides local storage and disk management functionalities to CassetteOS."
arch=('x86_64' 'aarch64' 'armv7h')
url="https://github.com/BeesNestInc/CassetteOS-LocalStorage"
license=('APACHE')
groups=('cassetteos')
backup=('etc/cassetteos/local-storage.conf')
source_x86_64=(
...
package() {
	...
	install -Dm644 "${_sysdir}/etc/cassetteos/${_name}.conf.sample" "${pkgdir}/etc/cassetteos/${_name}.conf"
